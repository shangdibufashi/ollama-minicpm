...
```bash
python ./examples/minicpmv/minicpmv-convert/minicpmv2_5-surgery.py -m ../MiniCPM-Llama3-V-2_5
...
./llama-quantize ../MiniCPM-Llama3-V-2_5/model/ggml-model-f16.gguf ../MiniCPM-Llama3-V-2_5/model/ggml-model-Q4_K_M.gguf Q4_K_M
```
...
```
# run f16 version
./llama-minicpmv-cli -m ../MiniCPM-Llama3-V-2_5/model/ggml-model-f16.gguf --mmproj ../MiniCPM-Llama3-V-2_5/mmproj-model-f16.gguf -c 4096 --temp 0.7 --top-p 0.8 --top-k 100 --repeat-penalty 1.05 --image xx.jpg -p "What is in the image?"
